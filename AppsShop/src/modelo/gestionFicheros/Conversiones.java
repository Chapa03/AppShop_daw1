...
public class Conversiones {
	...
	public static List<String> obtenerListaStrings(List<Aplicacion> listaAplicaciones){
		...
		temp.add("");
		temp.add("Nombre App:\t\tTamaño en MB:\tClasific. edad:\t\tDescripción:");
		temp.add("----------------------------------------------------------------------------");
		String tabNombre = "";
		String tabEdad = "\t\t";
		...
		for (Aplicacion app : listaAplicaciones) {
			...
			temp.add(app.getNombreApp() + tabNombre + app.getPeso() + "MB" + tabEdad + app.getEdadMinima() + " Años\t\t" + app.getDescripcion());
		}
		return temp;
	}
	...
	public static List<String> obtenerListaUsuarios(List<Usuario> listaUsuarios){
		...
		temp.add("");
		temp.add("Alias:\t\tNombre completo:\tFecha de nacimiento:\tPaís\tCorreo:\t\t¿Desarrollador?");
		temp.add("----------------------------------------------------------------------------");
